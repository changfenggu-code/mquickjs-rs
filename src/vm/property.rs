...
use super::interpreter::{
    ...
    BUILTIN_INT8_ARRAY, BUILTIN_INT16_ARRAY, BUILTIN_INT32_ARRAY, BUILTIN_JSON, BUILTIN_MATH,
    BUILTIN_NUMBER, BUILTIN_OBJECT, BUILTIN_PERFORMANCE, BUILTIN_REGEXP, BUILTIN_STRING,
    BUILTIN_UINT8_ARRAY, BUILTIN_UINT8_CLAMPED_ARRAY, BUILTIN_UINT16_ARRAY, BUILTIN_UINT32_ARRAY,
    Interpreter,
};
